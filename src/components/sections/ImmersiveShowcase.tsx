...
const experienceData = [
  {
    ...
    company: 'Studio X',
    description:
      'Led redesign of core digital products and established a new design system.',
  },
  {
    year: '2022',
    role: 'Product Designer',
    company: 'TechCorp',
    description: 'Spearheaded UI/UX for the flagship mobile application.',
  },
  {
    year: '2020',
    role: 'UI Designer',
    ...
    description:
      'Worked on various client projects, creating engaging landing pages.',
  },
  {
    year: '2018',
    role: 'Junior Designer',
    company: 'Startup Inc',
    description: 'Assisted in branding and web design.',
  },
];
